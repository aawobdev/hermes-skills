...
- Local LLMs on ollama VM (192.168.1.123): Ollama + LM Studio. Live model list at http://192.168.1.123:11434/api/tags. Local: qwen3-coder:30b (primary coder, MoE), gpt-oss:20b (OpenAI open-weight, MoE, MXFP4, coding/math/tool use), devstral:24b (agentic coder, vision), gemma4:26b (vision+general, MoE), phi4:14b (STEM/math), deepseek-r1:8b (fast reasoning). Cloud (OpenRouter): deepseek-v4-flash (default), qwen3-coder-next, devstral-small-2, gemma3, qwen3.5 (397B-A17B, vision).
...
- Test coverage and seed data matter. CSS Modules, build-must-pass, no port-hopping. Function-first, polish-
