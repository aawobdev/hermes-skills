...
- Amex reconciliation: cron job reads credit card statements via Google Sheets service account at amex-reconcile@hermes-499012.iam.gserviceaccount.com, key at ~/.gdrive-mcp/amex-service-account.json.
- Projects under ~/projects/ are auto-synced via repo-sync cron job.
